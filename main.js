...
var _user$project$EmbedVega$display = F2(
	function (name, value) {
		return A2(
...
var _user$project$EmbedVega$showCurrentRoll = function (model) {
	var _p0 = model.dieFace;
	if (_p0.ctor === 'Just') {
		return A2(
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Click Roll to roll the die'),
				_1: {ctor: '[]'}
			});
	}
};
var _user$project$EmbedVega$spec = function (model) {
		...
		return A2(
			...
			A3(
				...
				_gicentre$elm_vega$VegaLite$nums(
					A2(_elm_lang$core$List$map, _elm_lang$core$Basics$toFloat, model.rolls)),
				_p2));
	};
...
var _user$project$EmbedVega$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$EmbedVega$updateRolls = F2(
	function (face, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				rolls: {ctor: '::', _0: face, _1: model.rolls}
			});
	});
var _user$project$EmbedVega$updateFace = F2(
	function (face, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				dieFace: _elm_lang$core$Maybe$Just(face)
			});
	});
var _user$project$EmbedVega$elmToJS = _elm_lang$core$Native_Platform.outgoingPort(
	'elmToJS',
	function (v) {
		return v;
	});
var _user$project$EmbedVega$Model = F2(
	function (a, b) {
		return {dieFace: a, rolls: b};
	});
var _user$project$EmbedVega$init = {
	ctor: '_Tuple2',
	_0: A2(
		_user$project$EmbedVega$Model,
		_elm_lang$core$Maybe$Nothing,
		{ctor: '[]'}),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$EmbedVega$NewFace = function (a) {
	return {ctor: 'NewFace', _0: a};
};
var _user$project$EmbedVega$update = F2(
	function (msg, model) {
		var _p3 = msg;
		if (_p3.ctor === 'Roll') {
			return {
				...
				_1: A2(
					_elm_lang$core$Random$generate,
					_user$project$EmbedVega$NewFace,
					A2(_elm_lang$core$Random$int, 1, 6))
			};
		} else {
			var _p4 = _p3._0;
			var newModel = A2(
				_user$project$EmbedVega$updateRolls,
				_p4,
				A2(_user$project$EmbedVega$updateFace, _p4, model));
			return {
				ctor: '_Tuple2',
				_0: newModel,
				_1: _user$project$EmbedVega$elmToJS(
					_user$project$EmbedVega$spec(newModel))
			};
		}
	});
var _user$project$EmbedVega$Roll = {ctor: 'Roll'};
var _user$project$EmbedVega$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$EmbedVega$showCurrentRoll(model),
			_1: {
				ctor: '::',
				_0: A2(_user$project$EmbedVega$display, '20 Rolls', model.rolls),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$EmbedVega$Roll),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$EmbedVega$main = _elm_lang$html$Html$program(
	{init: _user$project$EmbedVega$init, view: _user$project$EmbedVega$view, update: _user$project$EmbedVega$update, subscriptions: _user$project$EmbedVega$subscriptions})();

var Elm = {};
Elm['EmbedVega'] = Elm['EmbedVega'] || {};
if (typeof _user$project$EmbedVega$main !== 'undefined') {
    _user$project$EmbedVega$main(Elm['EmbedVega'], 'EmbedVega', undefined);
}
